...
description: Decide ranking period, playlist size, channel scope and treatment of unresolved Spotify matches.
...
- Current assumption A-003: top 50 unique songs from the last 30 complete Europe/Zurich days, public playlist.
...
- Spotify playlists are public; existing managed playlists are updated during synchronization.